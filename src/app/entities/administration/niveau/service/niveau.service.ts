...
export class NiveauService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/niveaus', 'administration');
  public resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/niveaus', 'administration');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<INiveau[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
