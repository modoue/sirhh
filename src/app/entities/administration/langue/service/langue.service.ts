...
export class LangueService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/langues', 'administration');
  public resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/langues', 'administration');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ILangue[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
