...
export class FamilleService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/familles', 'administration');
  public resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/familles', 'administration');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IFamille[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
