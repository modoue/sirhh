  ...
  describe('Formation Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        id: 0,
        version: 0,
        codeFormation: 'AAAAAAA',
        libelleFormation: 'AAAAAAA',
      };
    });
   ...
   //     expect(expectedResult).toMatchObject(elemDefault);
        ...
        const returnedFromService = Object.assign(
          {
            id: 1,
            version: 1,
            codeFormation: 'BBBBBB',
            libelleFormation: 'BBBBBB',
          },
          elemDefault
        );
      ...
      it('should partial update a Formation', () => {
        const patchObject = Object.assign({}, new Formation());
    ...
    //    expect(expectedResult).toMatchObject(expected);
      ...
      //    expect(expectedResult).toHaveLength(2);
        ...
        it('should add only unique Formation to an array', () => {
          const formationArray: IFormation[] = [{ id: 123 }, { id: 456 }, { id: 56743 }];
