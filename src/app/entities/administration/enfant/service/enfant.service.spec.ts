  ...
  describe('Enfant Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        ...
        version: 0,
        nomEnfant: 'AAAAAAA',
        prenomEnfant: 'AAAAAAA',
        indACharge: false,
        indScolarise: false,
        indEnfantHandicape: false,
        dateDebutScolarisation: currentDate,
        dateFinScolarisation: currentDate,
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            dateDebutScolarisation: currentDate.format(DATE_FORMAT),
            dateFinScolarisation: currentDate.format(DATE_FORMAT),
          },
          elemDefault
        );
      ...
      //    expect(expectedResult).toHaveLength(2);
       ...
       //   expect(expectedResult).toHaveLength(2);
        ...
        it('should add only unique Enfant to an array', () => {
          const enfantArray: IEnfant[] = [{ id: 123 }, { id: 456 }, { id: 88324 }];
