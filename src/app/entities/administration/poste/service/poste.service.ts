...
export class PosteService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/postes', 'administration');
  public resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/postes', 'administration');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPoste[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
